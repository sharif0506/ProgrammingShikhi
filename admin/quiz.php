            ...
            <div class="gridwrapper">
                ...
                <div class="gridbox gridmain">
                    <div class="main">
                        <div class="login">
                            <h1>Quiz</h1>
                            <a href="quizAdd.php" ><button class='buttonNext' style='vertical-align:middle'><span>Quiz Add</span></button> </a>
                            <br />
                            <br />
                            <a href="quizEdit.php" ><button class='buttonNext' style='vertical-align:middle'><span>Quiz Edit</span></button> </a>
                            <br />
                            <br />
